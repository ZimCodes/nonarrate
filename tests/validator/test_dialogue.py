...
class TestDialogue(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.dialogues = {
            ...
            145: '"Narrator" "Smiles *very softly."',
            ...
            157: 'myvar = "Smiles *very softly*"',
            158: 'myvar = "Smiles *very softly"',
            ...
            164: '"~Jim liked driving around town with his hazard lights on.~"',
            165: 'mc "Smiles ~very softly."',
            166: 'mc "Smiles very ~softly~"',
            167: 'mc "~Smiles very ~softly~"',
            ...
            177: '"Narrator" "Smiles ~very softly."',
            178: '"Narrator" "Smiles ~very softly~"',
            179: '"Narrator" "~Smiles ~very softly~"',
            ...
            189: 'myvar = "Smiles ~very softly~"',
            190: 'myvar = "Smiles ~very softly"',
            191: 'myvar = "~Smiles ~very softly~"',
